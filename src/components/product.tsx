...
export const Product = ({ product }: { product: ProductType }) => {
    ...
    const addToCart = (product: any) => {
        ...
        setTimeout(() => setButtonText("Añadir al carrito"), 1000);
    };
    ...
    return (
        <>
            ...
            <div className="flex z-10 justify-between lg:w-5/12 w-8/12 mx-auto bg-white p-5 text-text rounded-xl">
                <div>
                    <p className="font-semibold text-sm">Precio Total</p>
                    <p className="font-bold text-lg">
                        {getCurrencySymbol(
                            defaultPrice?.currency ?? "MXM",
            ...
            <p className="text-text mb-4 font-semibold">Donas Relacionadas</p>
